# This script includes code from the following GitHub repository:
# https://github.com/CarperAI/trlx
# Original code can be found in examples/summarize_rlhf/reward_model/reward_model.py.
# The code is used under the terms of the MIT license.
...
class GPTRewardModel(nn.Module):
    def __init__(self, model_path):
        ...
        self.tokenizer = AutoTokenizer.from_pretrained("EleutherAI/gpt-j-6B", padding_side="right")
