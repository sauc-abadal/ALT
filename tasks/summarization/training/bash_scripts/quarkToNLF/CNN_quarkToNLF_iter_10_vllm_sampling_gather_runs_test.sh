...
input_file=/cluster/work/sachan/NLF/CNN_daily_mail/quarkToNLF_v2_iter_10/CNN_daily_mail_test_split_prompts.json

output_dir=/cluster/work/sachan/NLF/CNN_daily_mail/quarkToNLF_v2_iter_10
...
sbatch --dependency=afterok:$sample1:$sample2:$sample3:$sample4 tasks/summarization/training/bash_scripts/quarkToNLF/CNN_quarkToNLF_iter_10_reward_gather_runs_test.sh
