...
input_file=/cluster/work/sachan/NLF/CarperAI_test_prompts/quarkToNLF_v2_iter_1/CarperAI_100samples_test_set.json

output_dir=/cluster/work/sachan/NLF/CarperAI_test_prompts/quarkToNLF_v2_iter_1
model_path=/cluster/work/sachan/NLF/quarkToNLF_v2/model/iter_1/model_ckp_1
...
sbatch --dependency=afterok:$sample1:$sample2:$sample3:$sample4 tasks/summarization/training/bash_scripts/quarkToNLF/quarkToNLF_iter_1_reward_gather_runs_test.sh
