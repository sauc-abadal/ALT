...
input_sampling_file="/cluster/work/sachan/NLF/quark/output_iter_10/quark_sampling_data_valid_split_iter_10.json"
...
sbatch --dependency=afterok:$reward1:$reward2:$reward3:$reward4:$reward5:$reward6:$reward7:$reward8 tasks/summarization/training/bash_scripts/quark_ppl_TLDR.sh
