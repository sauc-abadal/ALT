...
input_sampling_file_train="/cluster/work/sachan/NLF/CarperAI_test_prompts/quarkToNLF_v2_iter_10/quarkToNLF_sampling_data_valid_split_100random_subset.json"
file_prefix_train="quarkToNLF_sampling_data_valid_split_100random_subset"
