...
input_file=/cluster/work/sachan/NLF/CarperAI_test_prompts/PPO/TLDR_test_split_prompts.json
...
sbatch --dependency=afterok:$sample1:$sample2:$sample3:$sample4 tasks/summarization/training/bash_scripts/baselines/PPO_reward_gather_runs_test.sh
