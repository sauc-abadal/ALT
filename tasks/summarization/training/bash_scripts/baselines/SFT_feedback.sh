...
input_sampling_file_train="/cluster/work/sachan/NLF/CarperAI_test_prompts/SFT/SFT_sampling_data_valid_split_100random_subset.json"
file_prefix_train="SFT_sampling_data_valid_split_100random_subset"
