...
input_sampling_file="/cluster/work/sachan/NLF/quark/output_iter_6/quark_sampling_data_valid_split_iter_6.json"
output_dir="/cluster/work/sachan/NLF/quark/output_iter_6/"
