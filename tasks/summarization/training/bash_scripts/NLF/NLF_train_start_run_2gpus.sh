...
#SBATCH --time=6:00:00
#SBATCH --output="/cluster/work/sachan/NLF/nlf_v2/slurm_output/NLF_training_TLDR_v1_noKL_2gpu.out"
...
accelerate launch --config_file "$1" tasks/summarization/training/NLF_train_noKL.py \
    --config "$2" \
    --iteration "$3" \
