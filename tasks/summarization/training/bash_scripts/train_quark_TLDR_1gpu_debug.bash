...
accelerate launch --config_file /cluster/project/sachan/sauc/nlf/tasks/summarization/training/configs/accelerate_config_ds_1gpu_ds_opt_ds_sch_cpu_off.yaml tasks/summarization/training/quark_train_debug.py --config tasks/summarization/training/configs/quark_TLDR_config_debug.yaml --sampling_stage 2 --step_num 4500 --ds_optimizer --ds_scheduler
