...
input_sampling_file="/cluster/work/sachan/NLF/quarkToNLF/output_iter_1/quark_sampling_data_valid_split_iter_1.json"
...
sbatch --dependency=afterok:$reward1:$reward2:$reward3:$reward4:$reward5:$reward6:$reward7:$reward8 tasks/summarization/training/bash_scripts/quarkToNLF_ppl_TLDR.sh
