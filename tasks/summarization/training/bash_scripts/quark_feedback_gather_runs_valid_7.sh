...
input_sampling_file="/cluster/work/sachan/NLF/quark/output_iter_7/quark_sampling_data_valid_split_iter_7.json"
output_dir="/cluster/work/sachan/NLF/quark/output_iter_7/"
