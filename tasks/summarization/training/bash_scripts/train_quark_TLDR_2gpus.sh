...
#SBATCH --output="/cluster/work/sachan/NLF/slurm_output/quark_training_TLDR_5q_v6_noKL_2gpu_iter_5.out"
...
iteration=5
input_sampling_file=/cluster/work/sachan/NLF/output_iter_5/quark_sampling_data_train_split_iter_5.json
output_dir=/cluster/work/sachan/NLF/output_iter_5/
file_prefix=quark_sampling_data_train_split_iter_5
