...
#SBATCH --time=2:00:00
#SBATCH --output="output/quark_full_eval_TLDR_5q_sampling_stage_2.out"
...
mv /cluster/work/sachan/sauc/nlf/quark_TLDR_5q/sampling/quark_sampling_data_valid_stage_2_worker_0.json /cluster/work/sachan/sauc/nlf/quark_TLDR_5q/sampling/quark_sampling_data_valid_stage_2.json
