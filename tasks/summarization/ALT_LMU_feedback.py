...
from alt.utils.utils import ensure_dir, OPENAI_KEY, remove_conditioning_from_str
...
def main():
    ...
    for sample in samples:
        sample["prompt"] = remove_conditioning_from_str(sample["prompt"].strip(), flag=args["ALT"])  
...
A summary is accurate if it doesn't contain made up facts \
...
and that there is always a tradeoff between coverage and conciseness. \
