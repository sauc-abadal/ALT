...
output_dir="/cluster/work/sachan/NLF/hh_nlf_v2/references/"

input_sampling_file_valid="/cluster/work/sachan/NLF/hh_nlf_v2/references/references_data_test_1000subset.json"
