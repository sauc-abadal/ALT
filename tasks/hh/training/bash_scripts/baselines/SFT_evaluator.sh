...
output_dir="/cluster/work/sachan/NLF/hh_nlf_v2/SFT/"

input_sampling_file_valid="/cluster/work/sachan/NLF/hh_nlf_v2/SFT/SFT_sampling_data_test_1000subset.json"
