...
tokenizer_path="reciprocate/ppo_hh_pythia-6B"
...
output_dir="/cluster/work/sachan/NLF/hh_nlf/PPO/"

input_sampling_file_valid="/cluster/work/sachan/NLF/hh_nlf/PPO/PPO_sampling_data_test_1000subset.json"
file_prefix_valid="PPO_sampling_data_test_1000subset"

model_path="reciprocate/ppo_hh_pythia-6B"
