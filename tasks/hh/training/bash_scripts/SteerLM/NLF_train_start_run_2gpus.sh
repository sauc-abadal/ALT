...
#SBATCH --time=4:00:00
#SBATCH --output="/cluster/work/sachan/NLF/hh_SteerLM/slurm_output/SteerLM_training_HH_v0_noKL_2gpu.out"
...
accelerate launch --config_file "$1" tasks/hh/training/SteerLM_train_noKL.py \
    --config "$2" \
    --iteration "$3" \
