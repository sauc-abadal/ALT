...
from alt.training_dataset_and_collator import ALT_LMC_TrainingDataset, TrainingSequenceCollatorWithPadding
from alt.data_pool import ALT_LMC_DataPool
...
def main():
    ...
    feedback_categories = args['train']['feedbacks']
    ...
    accelerator.print("############### SteerLM_train_noKL.py ###############")
    ...
    data_pool = ALT_LMC_DataPool(tokenizer=tokenizer)
    ...
    training_dataset = ALT_LMC_TrainingDataset(
        datapool=data_pool, 
        tokenizer=tokenizer,
        feedback_prefix="",
        prompt_prefix=".\n\n",
